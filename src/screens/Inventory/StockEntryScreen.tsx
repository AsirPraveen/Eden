...
import {
  collection, doc, setDoc, updateDoc, increment, serverTimestamp, Timestamp,
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        {renderInput('Medicine Name', medicineName, setMedicineName, { placeholder: 'e.g., Amoxicillin 500mg', required: true })}
